      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-wrap gap-6 items-center">
          <div className="flex items-center gap-2 text-white/50 text-sm">
            ...
            Karat 34, Yenibosna Merkez, Kat 11, 34100 Bahçelievler/İstanbul
          </div>
          <div className="flex items-center gap-2 text-white/50 text-sm">
            <span className="text-gold-400">📱</span>+90 554 674 5516
          </div>
          <div className="flex items-center gap-2 text-white/50 text-sm">
            <span className="text-gold-400">✉️</span>info@nodenscare.com
          </div>
        </div>
      </div>
