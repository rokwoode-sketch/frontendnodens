            ...
            {posts.map((post, i) => (
              ...
              >
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  <img src={post.image_url} alt={post.title} width={688} height={400} loading="lazy" decoding="async" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                ...
                <div className="p-7">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    ...
                    <Link to={categoryLinks[post.category] || '/'} className="text-xs font-semibold text-gray-400 hover:text-gold-600 transition-colors flex items-center gap-1">
                      ...
                      {post.category} {p.procedures} <ChevronRight size={12} />
                    ...
                    <Link to={`/blog/${post.slug}`} className="flex items-center gap-1.5 text-gold-600 hover:text-gold-700 font-semibold text-sm transition-colors">
                      ...
                      {p.readGuide} <ArrowRight size={14} />
